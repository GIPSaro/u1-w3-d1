...
let oldestMovie = [];
let result = { Year: 2100 };
movies.forEach((oldestMovie) => {
  oldestMovie += movies.Year;
  if (oldestMovie < result.Year) {
    result = oldestMovie;
  }
});
...
console.log(`I fimlm contenuti nell'array sono:" ${lenght}`);
